...
function Chatting(props: any) {
	...
	const { isLoading: titleLoading, data: chat } = useQuery<IChatListProps>(['findroom', Mydata?.nickname], () => getWhereAreYou(Mydata?.nickname),{enabled: !!Mydata?.nickname, refetchInterval: 1000});
